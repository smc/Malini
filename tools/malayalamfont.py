...
class MalayalamFont(Font):
    ...
    def setFontInfo(self):
        ...
        self.info.openTypeOS2TypoLineGap = int((self.info.ascender + self.info.descender)/4) # For 1.4 line height
        ...
        self.info.openTypeHheaLineGap = int((self.info.ascender + self.info.descender)/4) # For 1.4 line height
